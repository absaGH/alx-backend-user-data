...
def register_user(email: str, password: str) -> None:
    """ Register User & assert of the values
    """
    reg_user = {
        "email": email,
        "password": password,
...
def log_in_wrong_password(email: str, password: str) -> None:
    """ Login with error & assert of the values
    """
    reg_user = {
        "email": email,
        "password": password,
...
def log_in(email: str, password: str) -> str:
    """ Login correctly & assert of the values
    """
    reg_user = {
        "email": email,
        "password": password,
...
def profile_logged(session_id: str) -> None:
    """ Profile logged & assert of the values
    """
    cookie = {
...
def log_out(session_id: str) -> None:
    """ Logout profile & assert of the values
    """
    cookie = {
        "session_id": session_id
    }
...
def reset_password_token(email: str) -> str:
    """ Reset password token & assert of the values
    """
    reg_user = {
        "email": email
    }
